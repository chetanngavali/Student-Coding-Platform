...
import { Play, Save, Share2, Settings, Eye, Code, Smartphone, Monitor, Tablet } from 'lucide-react';
      ...
      <div className="grid lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              {projects.map((project, index) => (
                <div 
                  ...
                  className={`p-3 rounded-lg cursor-pointer transition-all ${
                    index === 0 ? 'bg-purple-50 border-2 border-purple-200' : 'bg-gray-50 hover:bg-gray-100'
                  }`}
                >
            ...
            <button className="w-full mt-4 py-2 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-lg font-medium hover:shadow-lg transition-all duration-200">
              New Project
            </button>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="p-4">
              ...
              <div className="mt-4 text-center">
                <button className="w-full py-2 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200 transition-colors flex items-center justify-center space-x-2">
      ...
      <div className="mt-8 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 border border-purple-200">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="bg-white p-4 rounded-lg">
            ...
            <button className="text-xs bg-purple-100 text-purple-700 px-3 py-1 rounded-full">Apply</button>
          </div>
          <div className="bg-white p-4 rounded-lg">
            ...
            <button className="text-xs bg-blue-100 text-blue-700 px-3 py-1 rounded-full">Apply</button>
          </div>
          <div className="bg-white p-4 rounded-lg">
            ...
            <button className="text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full">Apply</button>
          </div>
        </div>
      </div>
    </div>
